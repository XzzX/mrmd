...
private:
    ...
    using PreForcePolicy = Kokkos::RangePolicy<Kokkos::Serial, TagPreForce, Kokkos::IndexType<idx_t>>;
    using PostForcePolicy = Kokkos::RangePolicy<Kokkos::Serial, TagPostForce, Kokkos::IndexType<idx_t>>;
