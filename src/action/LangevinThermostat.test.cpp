...
TEST_F(LangevinThermostatTest, Simple)
{
    ...
    EXPECT_GE(force(0, 0),
              9_r + langevinThermostat.pref1 * 1.5_r * 7_r -
                  langevinThermostat.pref2 * std::sqrt(1.5_r) * 0.5_r);
    EXPECT_LE(force(0, 0),
              9_r + langevinThermostat.pref1 * 1.5_r * 7_r +
                  langevinThermostat.pref2 * std::sqrt(1.5_r) * 0.5_r);
    EXPECT_GE(force(0, 1),
              7_r + langevinThermostat.pref1 * 1.5_r * 5_r -
                  langevinThermostat.pref2 * std::sqrt(1.5_r) * 0.5_r);
    EXPECT_LE(force(0, 1),
              7_r + langevinThermostat.pref1 * 1.5_r * 5_r +
                  langevinThermostat.pref2 * std::sqrt(1.5_r) * 0.5_r);
    EXPECT_GE(force(0, 2),
              8_r + langevinThermostat.pref1 * 1.5_r * 3_r -
                  langevinThermostat.pref2 * std::sqrt(1.5_r) * 0.5_r);
    EXPECT_LE(force(0, 2),
              8_r + langevinThermostat.pref1 * 1.5_r * 3_r +
                  langevinThermostat.pref2 * std::sqrt(1.5_r) * 0.5_r);
