...
INSTANTIATE_TEST_SUITE_P(
    ShiftXYZ,
    UpdateGhostAtomsTest,
    testing::Values(UpdateGhostAtomsTestData{{real_t(0.2), real_t(0.2), real_t(0.2)}, {real_t(1), real_t(1), real_t(1)}},
                    UpdateGhostAtomsTestData{{real_t(-0.2), real_t(-0.2), real_t(-0.2)}, {real_t(-1), real_t(-1), real_t(-1)}}));
