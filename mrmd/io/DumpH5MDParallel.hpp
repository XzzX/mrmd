...
public:
    ...
    hid_t forceGroupId;
    hid_t forceStepSetId;
    hid_t forceTimeSetId;
    hid_t forceValueSetId;
    hid_t massGroupId;
    hid_t massStepSetId;
    hid_t massTimeSetId;
    hid_t massValueSetId;
    hid_t posGroupId;
    hid_t posStepSetId;
    hid_t posTimeSetId;
    hid_t posValueSetId;
    hid_t relativeMassGroupId;
    hid_t relativeMassStepSetId;
    hid_t relativeMassTimeSetId;
    hid_t relativeMassValueSetId;
    hid_t typeGroupId;
    hid_t typeStepSetId;
    hid_t typeTimeSetId;
    hid_t typeValueSetId;
    hid_t velGroupId;
    hid_t velStepSetId;
    hid_t velTimeSetId;
    hid_t velValueSetId;
